! function(a) {
    ...
    a.fn.doAutosize = function(b) {
        ...
        var f = jQuery.extend({ interactive: !0, defaultText: "Tag", minChars: 0, width: "100%", height: "50px", autocomplete: { selectFirst: !1 }, hide: !0, delimiter: ",", unique: !0, removeWithBackspace: !0, placeholderColor: "#666666", autosize: !0, comfortZone: 20, inputPadding: 12 }, e),
            g = 0;
